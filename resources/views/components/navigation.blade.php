                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        <a href="{{ route('home') }}"
                            ...
                            {{ Route::currentRouteName() == 'home' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"
                            aria-current="page">Home</a>
                        <a href="{{ route('dashboard') }}"
                            class="rounded-md px-3 py-2 text-sm font-medium 
                            {{ Route::currentRouteName() == 'dashboard' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                            Dashboard
                        </a>
                        <a href="{{ route('projects') }}"
                            class="rounded-md px-3 py-2 text-sm font-medium 
                            {{ Route::currentRouteName() == 'projects' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">Projects</a>
                        <a href="#"
